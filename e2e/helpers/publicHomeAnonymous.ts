...
/**
 * Visit `/` as an anonymous visitor: maintenance bypass (when configured) + auth cleanup so
 * Playwright does not inherit a signed-in session when reusing a local dev server.
 */
