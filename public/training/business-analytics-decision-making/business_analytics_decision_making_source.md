...
The live interactive version is the free microlearning course at **`/learn/free/business-analytics-decision-making`**. This document remains the author reference for stems and learning intent.
