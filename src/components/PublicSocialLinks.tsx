...
function PlatformIcon({ id, className }: { id: SocialPlatformId } & IconProps) {
  ...
  switch (id) {
    ...
    case 'bluesky':
      return (
        <svg {...common}>
          <path d="M12 10.2C10.4 7 8.2 5.2 6.3 5.2c-1.5 0-2.4.9-2.4 2.5 0 2.6 2 5.3 4.6 6.3-1.3.4-2 1.1-2 2 0 1.2 1 2 2.4 2 1.6 0 2.8-1.3 3.1-3.2" />
          <path d="M12 10.2c1.6-3.2 3.8-5 5.7-5 1.5 0 2.4.9 2.4 2.5 0 2.6-2 5.3-4.6 6.3 1.3.4 2 1.1 2 2 0 1.2-1 2-2.4 2-1.6 0-2.8-1.3-3.1-3.2" />
          <path d="M12 10.2v4.6" />
        </svg>
      )
    default:
