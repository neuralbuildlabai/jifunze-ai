...
export function PrivacyPolicyPage() {
  return (
    <PolicyChrome title="Privacy Policy" eyebrow="Legal">
      ...
      <h2 className="mt-8 text-base font-semibold text-white">4. Analytics</h2>
      <p>
      ...
      <h2 className="mt-8 text-base font-semibold text-white">5. Retention</h2>
      <p>
      ...
      <h2 className="mt-8 text-base font-semibold text-white">6. Your choices &amp; rights</h2>
      <p>
      ...
      <h2 className="mt-8 text-base font-semibold text-white">7. International transfers</h2>
      <p>
      ...
      <h2 className="mt-8 text-base font-semibold text-white">8. Children</h2>
      <p>
