  ...
  "ai-essentials::ae-m02-practice": [
    {
      ...
      body: "Expectation-setting is a professional responsibility. Your memo should be usable: something a new teammate could read on day one to calibrate before they build habits around misconceptions.",
    },
    {
    ...
    },
    {
      ...
      type: "output_prompt",
      title: "Artifact to produce",
      prompt: "Your expectation reset memo should name at least two beliefs specific to your team or industry — not generic AI misconceptions recycled from articles.",
      outputExpectation: "Expectation reset memo",
    },
    {
      id: "ae-m02-practice-lt-next",
      type: "next_step",
      body: "Bring your memo to ae-m03 — your myth list will tell you which tool categories your team is most likely to misuse.",
    }
  ],
  ...
  "ai-essentials::ae-m03-practice": [
    {
      ...
      type: "intro",
      eyebrow: "Practice lab",
      title: "Tool-fit decisions leave traces",
      body: "Your matrix should withstand a question from a skeptical IT or legal reviewer. If you’d change your selections after ten minutes of policy review, the matrix isn’t finished.",
    },
    {
    ...
    },
    {
      ...
      type: "output_prompt",
      title: "Artifact to produce",
      prompt: "Your tool-fit matrix should include a column for what would change your selection — one disqualifying signal per tool candidate.",
