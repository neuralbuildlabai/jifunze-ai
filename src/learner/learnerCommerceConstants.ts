...
/**
 * When true (default), workspace learners do not see checkout/subscription CTAs and the commerce layer treats flagship access as open
 * for navigation (purchase gate forced off in context). Set `VITE_LEARNER_MONETIZATION_UI_DISABLED=false` to restore purchase UI and gates.
 */
export const LEARNER_MONETIZATION_UI_DISABLED = import.meta.env.VITE_LEARNER_MONETIZATION_UI_DISABLED !== 'false'
