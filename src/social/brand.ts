/**
 * Approved brand constants — the single source of truth for the public career-skills site,
 * the social directory and the social-ops dashboard.
 *
 * Authority: `docs/AMENDMENT_001_2026-08-18_PIVOT.md` §5 and `OPERATIONS.md`.
 * Nothing here may be edited without amending those documents.
 */
...
export const STANDARD_DESCRIPTION =
  'Jifunze.ai shares practical career, income and AI skills for job seekers, students and new freelancers in Kenya and other emerging markets. Explore useful guidance on CVs, interviews, applications, practical AI, money skills and professional growth.'

/** Extended description — long-form "about" sections. */
export const EXTENDED_DESCRIPTION =
  'Jifunze.ai is a career-skills media brand helping job seekers, students and new freelancers build practical skills for work, income and opportunity. Our content covers CVs, interviews, job applications, practical AI, money skills and professional growth, with a focus on Kenya and other emerging markets. Your idea never sleeps.'
...
export const TARGET_AUDIENCE =
  'Job seekers, students and new freelancers in Kenya and other emerging markets'
